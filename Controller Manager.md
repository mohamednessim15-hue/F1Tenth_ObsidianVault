...
| -------------------------------------------------------------------------- | ----------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| `/vesc/high_level/`<br>`ackermann_cmd_mux`<br>`/input/nav_1` | `AckermannDriveStamped` | **Speed** and **Steering Angle** (the final control command).                           | Send commands to the VESC motor controller (actuators).   |
